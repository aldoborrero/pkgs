# Borrowed until it's merged into nixpkgs:
# https://github.com/sdellysse/nixpkgs/blob/3048fc9e4ed5603f2bce0611e86131abdd125fc7/nixos/modules/services/misc/filebrowser.nix
{
  config,
  pkgs,
  lib,
  ...
  config = let
    ...
    cmd = "${cfg.package}/bin/filebrowser --config='${cfg.dataDir}/config.json' --database='${cfg.dataDir}/database.boltdb'";
